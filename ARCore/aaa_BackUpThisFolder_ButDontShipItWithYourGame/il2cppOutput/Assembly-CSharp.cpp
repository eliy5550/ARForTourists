...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ARLocationsLoader_Start_m38D2B3FC8BA14E29BD99182A3F8021FE118BE537 (ARLocationsLoader_t3B418C115BA8F90821ED45CDDCD62F3C5C9EC3D1* __this, const RuntimeMethod* method) 
{
	...
	int32_t V_2 = 0;
	{
		...
		ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA* L_3 = (ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA*)(ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA*)SZArrayNew(ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA_il2cpp_TypeInfo_var, (uint32_t)L_2);
		__this->___aRLocations_4 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___aRLocations_4), (void*)L_3);
...
IL_0029:
	{
		...
		ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA* L_4 = __this->___aRLocations_4;
		int32_t L_5 = V_1;
		ARLocation_tF844EDEE7035C2E62A2E9D89019C08EDAEAB5692* L_6 = (ARLocation_tF844EDEE7035C2E62A2E9D89019C08EDAEAB5692*)il2cpp_codegen_object_new(ARLocation_tF844EDEE7035C2E62A2E9D89019C08EDAEAB5692_il2cpp_TypeInfo_var);
		NullCheck(L_6);
		ARLocation__ctor_mA714E1D6B7E9FF275E87E6A263EEEC221585CC41(L_6, NULL);
		NullCheck(L_4);
		ArrayElementTypeCheck (L_4, L_6);
		(L_4)->SetAt(static_cast<il2cpp_array_size_t>(L_5), (ARLocation_tF844EDEE7035C2E62A2E9D89019C08EDAEAB5692*)L_6);
		// for (int i = 0; i < size; i++)
		int32_t L_7 = V_1;
...
IL_004b:
	{
		// aRLocations[i].arModel = allprefabs[i];
		ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA* L_11 = __this->___aRLocations_4;
		int32_t L_12 = V_2;
		NullCheck(L_11);
		int32_t L_13 = L_12;
		ARLocation_tF844EDEE7035C2E62A2E9D89019C08EDAEAB5692* L_14 = (L_11)->GetAt(static_cast<il2cpp_array_size_t>(L_13));
		...
		NullCheck(L_14);
		L_14->___arModel_3 = L_18;
		Il2CppCodeGenWriteBarrier((void**)(&L_14->___arModel_3), (void*)L_18);
		// for (int i = 0; i < size; i++)
		int32_t L_19 = V_2;
...
IL_005f:
	...
	{
		// Instantiate(aRLocations[0].arModel, Vector3.zero, Quaternion.identity);
		ARLocationU5BU5D_tE258D686F61057E02C608983E1365E8F47629CDA* L_22 = __this->___aRLocations_4;
		NullCheck(L_22);
		int32_t L_23 = 0;
		ARLocation_tF844EDEE7035C2E62A2E9D89019C08EDAEAB5692* L_24 = (L_22)->GetAt(static_cast<il2cpp_array_size_t>(L_23));
		NullCheck(L_24);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_25 = L_24->___arModel_3;
