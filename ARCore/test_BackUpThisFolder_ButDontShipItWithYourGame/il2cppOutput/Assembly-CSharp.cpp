...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Unzipper_Update_mDD1A28B8A66FC68E3C3D29632BF7659B3CBB1D1F (Unzipper_tEDF23BC30CFB3238DB2798508E914FBA90FCD5C9* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (File.Exists(resourcesPath + "/ds.zip"))
		String_t* L_0 = __this->___resourcesPath_9;
		String_t* L_1;
		L_1 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(L_0, _stringLiteral261B5680E3ADF805C9975F49CACA71932ED8815F, NULL);
		bool L_2;
